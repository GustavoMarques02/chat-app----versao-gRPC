...
class ChatClientStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ReceiveMessage = channel.unary_unary(
                '/chat_service.ChatClient/ReceiveMessage',
                request_serializer=ChatService__pb2.Message.SerializeToString,
                response_deserializer=ChatService__pb2.EmptyMessage.FromString,
                )
...
def add_ChatClientServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'chat_service.ChatClient', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class ChatClient(object):
    ...
    def ReceiveMessage(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/chat_service.ChatClient/ReceiveMessage',
            ChatService__pb2.Message.SerializeToString,
            ChatService__pb2.EmptyMessage.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
