...
_CHATCLIENT = DESCRIPTOR.services_by_name['ChatClient']
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CHATCLIENT._serialized_start=201
  _CHATCLIENT._serialized_end=284
